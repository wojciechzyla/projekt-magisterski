...
![algorithm](readme_images/algorithm.png | width=400)

Screenshots from the application:
![user_input](readme_images/user_input.png | width=400)
![plan_](readme_images/plan_1.png | width=400)
![plan_2](readme_images/plan_2.png | width=400)
![plan_3](readme_images/plan_3.png | width=400)
